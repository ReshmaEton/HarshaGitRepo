...
//WebUI.selectOptionByLabel(findTestObject('CRM/Create_contact-Information/Other Contact Type'), OtherContactType, false)
...
//WebUI.selectOptionByLabel(findTestObject('CRM/Create_contact-Information/Contact Priority Preference ID'), ContactPriorityPreferenceID,  false)
//WebUI.selectOptionByLabel(findTestObject('CRM/Create_contact-Information/Contact Restriction Preference ID'), ContractRestrictionPreferenceID,  false)
WebUI.click(findTestObject('CRM/Create_contact-Information/button_Submit'))

WebUI.waitForElementPresent(findTestObject('CRM/Create_contact-Information/button_Final approval'), 9)

WebUI.waitForElementClickable(findTestObject('CRM/Create_contact-Information/button_Final approval'), 9)
