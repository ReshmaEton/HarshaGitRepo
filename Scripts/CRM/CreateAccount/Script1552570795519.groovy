...
WebUI.waitForElementVisible(findTestObject('CRM/Create Account/Close Account Window'), 5)

WebUI.click(findTestObject('CRM/Create Account/Close Account Window'))

WebUI.callTestCase(findTestCase('CommonCases/Logout'), [:], FailureHandling.CONTINUE_ON_FAILURE)

CustomKeywords.'sqlConnection.AccountScreen.connection'('jdbc:sqlserver://921067-ord-qadb\\qa:51962;databaseName=eton_rei_data', 
