...
//WebUI.selectOptionByLabel(findTestObject('CRM/Create Project/Strategic Initiative'), StrategicInitiative, false)
WebUI.setText(findTestObject('CRM/Create Project/Project Description'), ProjectDescription)

WebUI.selectOptionByLabel(findTestObject('CRM/Create Project/Owner'), Owner, false //System Account
    )

WebUI.selectOptionByLabel(findTestObject('CRM/Create Project/Target Relationship'), RelationName, false)

//WebUI.selectOptionByLabel(findTestObject('CRM/Create Project/Target Level'), TargetLevel, false)//Relationship
