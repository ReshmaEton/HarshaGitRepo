...
WebUI.waitForElementClickable(findTestObject('CRM/Create Portfolio/Click on Submit Btn'), 3)

WebUI.click(findTestObject('CRM/Create Portfolio/Click on Submit Btn'))

WebUI.waitForElementClickable(findTestObject('CRM/Create Portfolio/Final Approval Btn'), 3)
