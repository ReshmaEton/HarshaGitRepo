...
WebUI.callTestCase(findTestCase('CommonCases/Address/Address_AfterRelationship'), [('Add_Name') : Add_Name, ('Address1') : Address1, ('Address2') : Address2
        ...
        , ('AddDesc') : AddDesc, ('AddNote') : AddNote], FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('CRM/Address/CreateAddress_AfterRelationship/Address_CloseButton_AfterRelationship'))
