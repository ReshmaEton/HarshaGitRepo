...
WebUI.waitForElementVisible(findTestObject('CRM/Relationship/Porfolio_Tab'), waitTime)

//WebUI.sendKeys(findTestObject('CRM/Relationship/Porfolio_Tab'), Keys.chord(Keys.CONTROL,Keys.SUBTRACT), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('CRM/Relationship/Porfolio_Tab'), waitTime)
