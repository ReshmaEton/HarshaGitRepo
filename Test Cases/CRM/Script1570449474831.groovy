...
WebUI.waitForElementPresent(findTestObject('CRM/Create Investment Objectives/button_Final Approval'), 9)

WebUI.waitForElementClickable(findTestObject('CRM/Create Investment Objectives/button_Final Approval'), 9)
