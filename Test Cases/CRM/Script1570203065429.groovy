...
WebUI.waitForElementPresent(findTestObject('CRM/Create_Related_Parties/Final_Approval'), 9)

WebUI.waitForElementClickable(findTestObject('CRM/Create_Related_Parties/Final_Approval'), 9)
