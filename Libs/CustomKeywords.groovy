...
def static "com.jira.customkeywords.CustomFunctions.uploadFileBillPayTransactionProcessing"(
    	TestObject to	
     , 	String filePath	) {
    (new com.jira.customkeywords.CustomFunctions()).uploadFileBillPayTransactionProcessing(
        	to
         , 	filePath)
}
