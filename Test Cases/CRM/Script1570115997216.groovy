...
WebUI.waitForElementClickable(findTestObject('CRM/Edit_Account/Contains_k-textBox'), 6)

WebUI.setText(findTestObject('CRM/Edit_Account/Contains_k-textBox'), AccName)

WebUI.click(findTestObject('CRM/Edit_Account/button_Filter'))

WebUI.click(findTestObject('CRM/Edit_Account/selected Account Name'))
...
WebUI.waitForElementPresent(findTestObject('CRM/Create Account/Final Approval Btn Account'), 9)

WebUI.waitForElementClickable(findTestObject('CRM/Create Account/Final Approval Btn Account'), 9)
...
//
//WebUI.click(findTestObject('Object Repository/CRM/Edit_Account/Account_nameTextBox'))
//
//WebUI.waitForElementClickable(findTestObject('Object Repository/CRM/Edit_Account/Account_EditButton'), 6)
//
//WebUI.click(findTestObject('Object Repository/CRM/Edit_Account/Account_EditButton'))
//
//WebUI.waitForElementClickable(findTestObject('CRM/Create Account/AccountNumber'), 6)
//
//WebUI.clearText(findTestObject('CRM/Create Account/TradingCustodian'))
//
//WebUI.setText(findTestObject('CRM/Create Account/TradingCustodian'), TradingCustodian_Edit)
