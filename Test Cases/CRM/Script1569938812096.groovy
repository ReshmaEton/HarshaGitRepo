...
WebUI.verifyTextPresent(RelationName, true)
...
WebUI.waitForElementPresent(findTestObject('CRM/Relationship/button_SubmitRelationship'), 6)

WebUI.waitForElementClickable(findTestObject('CRM/Relationship/button_SubmitRelationship'), 6)

//WebUI.clearText(findTestObject('CRM/Relationship/Text_Relationship Name_form-c'))
...
WebUI.waitForElementPresent(findTestObject('CRM/Relationship/button_Final ApprovalRelationship'), 6)

WebUI.waitForElementClickable(findTestObject('CRM/Relationship/button_Final ApprovalRelationship'), 6)
